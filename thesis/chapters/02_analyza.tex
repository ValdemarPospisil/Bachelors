...
\begin{enumerate}
    ...
    \item \textbf{Znovupoužitelnost:} Využívá se již otestovaná a existující logika v .NET backendu, což je v souladu s hodnotou jednoduchosti (Simplicity) metodiky XP (\ref{sec:agile_teorie}).
\end{enumerate}
