...
Pro realizaci samotného šifrovaného spojení využívá GoodAccess dva dominantní protokoly: OpenVPN a WireGuard. Každý z nich představuje jinou generaci technologií a liší se především architekturou a flexibilitou správy.
