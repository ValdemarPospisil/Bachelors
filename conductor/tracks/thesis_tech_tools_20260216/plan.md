...
- [ ] Task: Research .NET 8 Generic Host and Systemd integration details from `literature/CSharp.12.and.NET.8.9781837635870.EBooksWorld.ir.pdf`.
- [ ] Task: Research Go CLI standards, Cobra, and Bubble Tea (Elm Architecture) from `literature/The.Go.Programming.Language.pdf`.
- [ ] Task: Review existing bibliography in `thesis/thesis.bib` to ensure `price_csharp` and `donovan_go` keys are present.
